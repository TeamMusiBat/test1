...
cl = LineClient(authToken="EBaeIhHmm0OxOqFbJmi5.KTOLDtNUiWTGWDrGURHqfq.5GxJBBrtUXlA4SsN+DbL13D4r8+yR6s0z4WAdZqwhtg=")
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken="EBmAePfSVOomFY1tt9F9.UG7/XfSMCeDcYAJgKpnmoq.UjekLNtrqI4XZ9852D0VkTYi3WkIpxgcFeIi6f7IGMk=")
...
kc = LineClient(authToken="EB91VE8X44t98IVuIMrf.rOzLOoQHdj7A8gLMLyHclW.FRlzLeKXpfQ7UoAq2+a4fYG4z44bl5vKmj60/QmOADw=")
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel.channelAccessToken))

kb = LineClient(authToken="EBrZWtenp4xl9jCcOm81.FU3v19kDZ4dW+NW09XRy0q.xs2grFhRIWtO+CeWIVyglrMgqFd+TJExmrdGMn+DYqo=")
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel.channelAccessToken))

kd = LineClient(authToken="EBn6lAjoSLl2GdJOs8Va.PRW4jJi6AsPG4s20Ar1dAG.WMqwzUbg7dcLZ/SggO5H9p3Yo3wO1C8EyrX8lhDuTHM=")
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel.channelAccessToken))

ke = LineClient(authToken="EB3EagTRk6VSNLHuadg9.uJu77uyfSdhaO+0YfYO/oq.A/YN+QQDMYgHsaDF/lhvHKD1BC09fqyPNBL8cwHeybo=")
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel.channelAccessToken))

kf = LineClient(authToken="EBQUQ8lbKIRk4zt2NgVb.TMQurRW9bKdFaXZDk1wPMW.W2b7G4pS1Gm+jxn6KDyLPchPvFZ/Rj9gBXDAgvb6SWI=")
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel.channelAccessToken))

kj = LineClient(authToken="EBc3heZSDfABtd34OzW4.W4hJ4gmnA2px6XdZ7z2gHa.uAIQJug2fA2wdf3LrfYEY56npCcp5JPN4AgSrVmooI4=")
kj.log("Auth Token : " + str(kj.authToken))
kj.log("Channel Access Token : " + str(channel.channelAccessToken))

sw = LineClient(authToken="EBwXSK6VlTqoszjqlKZ4.uXe/W+Xz/S5s2EXZCQ5LLa.C+SI5ubZUsyYRo+I3XZodO7F69t0yGEUJTdUVTLKMWo=")
...
wait = {
    ...
    "unsend":False,
    "mention":"انرت الكون مو بس القروب غلا 🌹🌹🌹",
    "Respontag":"هلا وغلا لبيه يا قلب الدمعه 🌹😍",
    "welcome":"اطلق من طب القروب حياك وبياك 🌹😍",
    "leave":"فديته المغادر 😥",
    "comment":" big like",
    "message":"حياك وبياك نورت حسابي المتواضع🌹🌹",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def help():
    ...
    key = key.title()
    helpMessage = "🇪🇬❂͜͡➣ " + key + " [🔰❂☞ dam3a♪❥☜❂+❂☞ dam3a☜❂]\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🇪🇬❂͜͡➣ " + key + " [🔰❂☞ dam3a♪❥☜❂+❂☞ dam3a☜❂]\n" + \
                  "🇪🇬❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🇪🇬❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "🇪🇬❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "🇪🇬❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                           ...
                           if msg._from in Bots:
                            if msg.toType == 2:
                             #  print "Otw cleanse"
                               ...
                               ki.sendMessage(msg.to,"اشوفكم علي خير ")
